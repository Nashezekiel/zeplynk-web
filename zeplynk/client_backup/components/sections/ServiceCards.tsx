                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            className="bg-zinc-900/40 border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors flex flex-col h-full group hover:bg-zinc-900/60"
                        >
                            {/* Icon Header */}
                            <div className={`w-14 h-14 rounded-2xl ${service.color} bg-opacity-10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                                <service.icon className={`h-7 w-7 ${service.color.replace('bg-', 'text-').replace('/10', '')}`} />
                            </div>

                            <h3 className="text-2xl font-bold text-white mb-2">{service.title}</h3>
                            <p className="text-sm font-medium text-gray-400 mb-6 italic border-b border-white/5 pb-4">
                                {service.target}
                            </p>

                            {/* Features List */}
                            <div className="flex-grow mb-8">
                                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-4">What's Included</h4>
                            ...
                            <div className="mt-auto pt-6 border-t border-white/5 bg-black/20 -mx-8 -mb-8 p-8 rounded-b-3xl">
                                <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Business Impact</h4>
