    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-zgreen-500/30 selection:text-zgreen-200 font-friendly">
            ...
            <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-zgreen-900/20 rounded-full blur-[120px] pointer-events-none" />
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-zgreen-500/10 border border-zgreen-500/20 mb-8 backdrop-blur-sm">
                        ...
                        <span className="text-sm font-medium text-zgreen-200 tracking-wide uppercase">Digital Engineering</span>
                    </div>
            ...
            <section id="product" className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto text-center mb-16">
                    <span className="text-zgreen-500 font-semibold tracking-wider uppercase text-sm">From Idea to Scale</span>
                    <h2 className="text-3xl sm:text-5xl font-bold text-white mt-2 mb-4">Product Development</h2>
                    <p className="text-gray-400 max-w-2xl mx-auto">Guidance through every stage of the product lifecycle.</p>
                </div>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="bg-zinc-800/20 border border-white/5 p-8 rounded-2xl hover:border-zgreen-500/30 transition-colors">
            ...
            <section id="systems" className="py-20 px-4 sm:px-6 lg:px-8 bg-black border-t border-white/5">
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-4 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500">AWS, Google Cloud, and Azure serverless deployments.</p>
                                </div>
                            </div>
                            <div className="flex gap-4 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500">Optimized schema design for SQL and NoSQL databases.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="bg-zinc-900 rounded-xl border border-white/10 p-6 font-mono text-xs text-green-400 overflow-hidden relative">
            ...
            <section className="py-24 px-4 text-center">
                <div className="max-w-4xl mx-auto bg-zgreen-900/10 border border-zgreen-500/20 rounded-3xl p-12 backdrop-blur-sm">
