...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.1, 0.8, 0.4); // Zeplynk Green-ish
    const vec3 baseColor2 = vec3(0.2, 0.5, 1.0); // Bright Blue
    const vec3 baseColor3 = vec3(0.05, 0.1, 0.3); // Deep contrast
