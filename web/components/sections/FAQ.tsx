        ...
        <>
            ...
            <div className="max-w-3xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-200 text-body font-medium">Everything you need to know about working with us.</p>
                </div>
                    ...
                    {faqs.map((faq, index) => (
                        <div
                            ...
                            className={`rounded-2xl border transition-all duration-300 ${openIndex === index
                                ...
                                : "bg-zinc-900/20 border-white/20 hover:bg-zinc-900/40"
                                }`}
                        >
                            <button
                            ...
                            >
                                <span className={`text-lg font-bold transition-colors ${openIndex === index ? "text-white" : "text-gray-200"
                                    }`}>
                                    {faq.question}
                                </span>
                                <div className={`p-2 rounded-full transition-colors ${openIndex === index ? "bg-zgreen-500/20 text-zgreen-500" : "bg-white/10 text-gray-400"
                                    }`}>
                            ...
                            <AnimatePresence>
                                {openIndex === index && (
                                    ...
                                    >
                                        <div className="px-6 pb-6 text-gray-200 leading-relaxed font-medium">
                                            {faq.answer}
                                        </div>
                                    </motion.div>
                                )}
