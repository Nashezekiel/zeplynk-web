...
const steps = [
    ...
    },
    {
        num: "02",
        title: "Strategy",
        desc: "Architecture & solution design.",
        icon: Lightbulb,
    ...
    },
    {
        num: "04",
        title: "Engineering",
        desc: "Agile development & testing.",
        icon: Code2,
...
export default function ProcessMap() {
    return (
        <section className="min-h-screen flex items-center py-12 px-4 sm:px-6 lg:px-8 bg-black relative overflow-hidden">
            {/* Background Decor */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="mb-12 text-center max-w-3xl mx-auto">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-zgreen-500 text-xs font-bold uppercase tracking-widest mb-4"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative">
                    ...
                    <div className="hidden md:block absolute top-[96px] left-[10%] right-[10%] h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent z-0" />
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            {/* Step Number */}
                            <div className="w-8 h-8 rounded-full bg-black border border-white/20 flex items-center justify-center text-[11px] font-bold text-gray-400 group-hover:text-zgreen-500 group-hover:border-zgreen-500/30 transition-all duration-500 mb-3 z-10">
                                {step.num}
                            </div>

                            {/* Icon */}
                            <div className="relative w-20 h-20 mb-5 rounded-[1.75rem] bg-zinc-900 border border-white/20 flex items-center justify-center group-hover:border-zgreen-500/50 transition-all duration-500 group-hover:rotate-[10deg] shadow-2xl overflow-hidden backdrop-blur-md z-10">
                                ...
                                <step.icon className="h-7 w-7 text-white relative group-hover:text-white transition-colors duration-500" />
                            </div>
                            ...
                            {index !== steps.length - 1 && (
                                <div className="md:hidden w-[1px] h-8 bg-white/5 my-3" />
                            )}
                        </motion.div>
                    ))}
                </div>
