        ...
        return (
            <div className="min-h-screen bg-black flex items-center justify-center px-4 font-friendly">
                <div className="max-w-md w-full text-center">
                    <div className="bg-zinc-900/60 border border-zgreen-500/50 rounded-2xl p-8 shadow-[0_0_50px_rgba(34,197,94,0.1)] backdrop-blur-md">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <div className="bg-zyellow-500/10 border border-zyellow-500/40 rounded-xl p-6 mb-6 backdrop-blur-sm">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-zgreen-500 transition-colors" />
                                    <input
                                        type="text"
                                        id="name"
                                        name="name"
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-zgreen-500 transition-colors" />
                                    <input
                                        type="email"
                                        id="email"
                                        name="email"
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-zgreen-500 transition-colors" />
                                    <input
                                        type="tel"
                                        id="phone"
                                        name="phone"
                            ...
                            {/* Course Interest */}
                            <div>
                                <label htmlFor="courseInterest" className="block text-sm font-bold text-white mb-2 uppercase tracking-wide">
                            ...
                            {/* Payment Proof */}
                            <div>
                                <label htmlFor="paymentProof" className="block text-sm font-bold text-white mb-2 uppercase tracking-wide">
                                    Proof of Payment (Optional)
                                </label>
                                <div className="relative group">
                                    <Upload className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-zgreen-500 transition-colors" />
                                    <input
                                        type="file"
                                        id="paymentProof"
                                        name="paymentProof"
                            ...
                            {/* Additional Note */}
                            <div>
                                <label htmlFor="additionalNote" className="block text-sm font-bold text-white mb-2 uppercase tracking-wide">
                                    Additional Notes
                                </label>
                                <div className="relative group">
                                    <FileText className="absolute left-3 top-3 h-5 w-5 text-gray-400 group-focus-within:text-zgreen-500 transition-colors" />
                                    <textarea
                                        id="additionalNote"
                                        name="additionalNote"
                                        rows={4}
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full bg-zinc-900/60 pl-10 pr-4 py-3 border border-white/20 rounded-xl focus:border-zgreen-500 focus:ring-1 focus:ring-zgreen-500 focus:outline-none transition-all duration-200 text-white placeholder-gray-500 resize-none font-medium"
