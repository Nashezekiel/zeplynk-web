...
import { ArrowLeft, Calendar, Tag, ArrowUpRight, BookOpen, TrendingUp, Lightbulb } from "lucide-react";
        ...
        <main className="min-h-screen bg-black text-white pt-32 pb-24 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <header className="mb-20">
                    ...
                    <div className="max-w-3xl">
                        ...
                        <p className="text-gray-400 text-xl font-medium leading-relaxed">
                            Deep-dives into scalable engineering, AI automation, and the future of digital infrastructure from the Zeplynk team.
                        </p>
                    </div>
                </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                    <ScrollReveal>
                        <div className="p-8 rounded-3xl bg-zinc-900/60 border border-white/20 hover:border-zgreen-500/30 transition-all duration-500 backdrop-blur-md group cursor-pointer">
                            <div className="w-12 h-12 rounded-xl bg-zgreen-500/10 flex items-center justify-center text-zgreen-500 mb-6 group-hover:scale-110 transition-transform">
                                <BookOpen className="h-6 w-6" />
                            </div>
                            <h3 className="text-2xl font-bold mb-3">Engineering</h3>
                            <p className="text-gray-400 font-medium">Technical deep-dives, architecture patterns, and best practices.</p>
                        </div>
                    </ScrollReveal>
                    <ScrollReveal delay={0.1}>
                        <div className="p-8 rounded-3xl bg-zinc-900/60 border border-white/20 hover:border-zgreen-500/30 transition-all duration-500 backdrop-blur-md group cursor-pointer">
                            ...
                            <p className="text-gray-400 font-medium">AI implementation strategies and automation case studies.</p>
                        </div>
                    </ScrollReveal>
                    <ScrollReveal delay={0.2}>
                        <div className="p-8 rounded-3xl bg-zinc-900/60 border border-white/20 hover:border-zgreen-500/30 transition-all duration-500 backdrop-blur-md group cursor-pointer">
                            ...
                            <h3 className="text-2xl font-bold mb-3">Industry Trends</h3>
                            <p className="text-gray-400 font-medium">Market analysis and future technology predictions.</p>
                        </div>
                    </ScrollReveal>
                </div>
