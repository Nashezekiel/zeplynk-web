...
import { ArrowLeft, ArrowRight, Calendar, Lightbulb, Send, CheckCircle, Mail, Sparkles } from "lucide-react";
    ...
    return (
        <main className="min-h-screen bg-black text-white pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                {/* Newsletter */}
                <div className="relative overflow-hidden p-6 sm:p-8 md:p-12 rounded-[2rem] bg-gradient-to-br from-zgreen-500/10 via-zinc-900/60 to-zinc-900/60 border border-zgreen-500/20 backdrop-blur-md">
