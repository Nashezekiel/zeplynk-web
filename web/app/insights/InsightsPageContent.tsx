...
import { ArrowLeft, Calendar, Lightbulb, BookOpen, TrendingUp } from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                    <ScrollReveal>
                        <div className="p-8 rounded-3xl bg-zinc-900/60 border border-white/20 hover:border-zgreen-500/30 transition-all duration-500 backdrop-blur-md group cursor-pointer">
                            ...
                            <p className="text-gray-400 font-medium">Technical deep-dives, architecture patterns, and best practices for Nigerian developers.</p>
                        </div>
                    </ScrollReveal>
                    <ScrollReveal delay={0.1}>
                        <div className="p-8 rounded-3xl bg-zinc-900/60 border border-white/20 hover:border-zgreen-500/30 transition-all duration-500 backdrop-blur-md group cursor-pointer">
                            ...
                            <p className="text-gray-400 font-medium">AI implementation strategies and automation case studies for Nigerian businesses.</p>
                        </div>
                    </ScrollReveal>
                    <ScrollReveal delay={0.2}>
                        <div className="p-8 rounded-3xl bg-zinc-900/60 border border-white/20 hover:border-zgreen-500/30 transition-all duration-500 backdrop-blur-md group cursor-pointer">
                            ...
                            <p className="text-gray-400 font-medium">Market analysis and future technology predictions for Africa&apos;s tech ecosystem.</p>
                        </div>
                    </ScrollReveal>
                </div>
