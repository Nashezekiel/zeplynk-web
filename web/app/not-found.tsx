                ...
                <div className="max-w-md w-full text-center relative z-10">
                    ...
                    <div className="bg-zinc-900/50 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <Link href="/register" className="block text-gray-400 hover:text-zgreen-500 transition-colors duration-200">
                                → Course Registration
                            </Link>
                            <Link href="/contact" className="block text-gray-400 hover:text-zgreen-500 transition-colors duration-200">
                                → Contact Us
                            </Link>
                        </div>
                    </div>
