...
export const metadata: Metadata = {
    ...
    keywords: [
        ...
        "web developer Jos",
        "AI automation Jos Nigeria",
        "coding bootcamp Jos Nigeria",
        "tech training Jos",
        "IT company Jos Nigeria",
        "digital transformation Jos Nigeria",
        "software development Plateau State",
    ],
    alternates: {
        canonical: "https://zeplynk.com/jos",
    },
    openGraph: {
        title: "Web Development & Tech Training in Jos, Plateau State | Zeplynk",
        description:
...
const josLocalBusinessSchema = {
    "@context": "https://schema.org",
    "@type": "ITService",
    name: "Zeplynk — Tech Solutions Jos",
    description: "Tech solutions and developer training serving Jos and Plateau State, Nigeria. Web development, AI automation, software engineering, and coding bootcamp programmes.",
    url: "https://zeplynk.com/jos",
                ...
                <section className="relative pt-36 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
                    ...
                    <div className="max-w-6xl mx-auto relative z-10">
                        ...
                        <p className="text-body text-gray-400 max-w-3xl mb-10 leading-relaxed">
                            ...
                            training to businesses in Jos, Plateau State, and northern Nigeria.
                            We serve Jos clients both in-person and remotely from our Kaduna headquarters.
                        </p>
                ...
                <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-white/5">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-gray-400 text-body mb-16 max-w-2xl leading-relaxed">
                            ...
                            Zeplynk delivers results for clients in Jos and Plateau State.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[
                                { title: "Website Development Jos", desc: "Professional websites and web applications for Jos businesses. Fast, mobile-friendly, and built to convert visitors into customers.", icon: "🌐", href: "/solutions" },
                                { title: "AI Solutions for Jos Businesses", desc: "Automate your business processes with AI. Custom chatbots, workflow automation, and smart data tools built for Nigerian businesses.", icon: "🤖", href: "/solutions" },
                                { title: "Developer Training in Jos", desc: "Zeplynk Academy offers online coding bootcamps accessible from Jos. Learn web development, backend engineering, and AI.", icon: "🎓", href: "/academy" },
                                { title: "Custom Software Development", desc: "Business management systems, CRM tools, mobile apps, and SaaS products — built for Jos and Nigerian businesses.", icon: "💻", href: "/solutions" },
                                { title: "E-commerce Development Jos", desc: "Online stores for Jos traders and businesses. Integrated with Nigerian payment gateways like Paystack and Flutterwave.", icon: "🛒", href: "/solutions" },
                                { title: "Tech Consulting Jos", desc: "Not sure what tech you need? We offer free strategy consultations to help Jos businesses find the right digital solution.", icon: "💡", href: "/contact" },
                            ].map((service) => (
                                <Link
                                    key={service.title}
                                    href={service.href}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <p className="text-gray-400 leading-relaxed mb-6">
                                    Zeplynk regularly works with clients in Jos, Plateau State. We deliver all
                            ...
                            <div className="rounded-3xl overflow-hidden border border-white/10">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126019.12!2d8.8921!3d9.8965!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x105375bba3b92949%3A0x8b23c6c25c7afc44!2sJos%2C%20Plateau%20State%2C%20Nigeria!5e0!3m2!1sen!2s!4v1716000000001!5m2!1sen!2s"
                                    width="100%"
                                    height="400"
                                    style={{ border: 0 }}
                                    allowFullScreen
                                    ...
                                    title="Zeplynk serving Jos, Plateau State, Nigeria"
                                />
                            </div>
                        </div>
                    </div>
