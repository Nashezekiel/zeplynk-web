                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {industries.map((item, index) => (
                            ...
                            >
                                ...
                                <h3 className="text-3xl font-bold text-white mb-4 group-hover:text-zgreen-400 transition-colors">{item.name}</h3>
                        ...
                        >
                            <h3 className="text-3xl font-bold text-white mb-6">Have a unique industry challenge?</h3>
